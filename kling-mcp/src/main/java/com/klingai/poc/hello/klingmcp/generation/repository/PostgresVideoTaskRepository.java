...
public class PostgresVideoTaskRepository implements VideoTaskRepository {
    ...
    public boolean markCallbackEventProcessed(String eventKey) {
        ...
        try {
            callbackEventMapper.insert(new CallbackEventEntity("video:" + eventKey, Instant.now()));
            return true;
        }
    ...
    private TaskEntity toEntity(VideoTask task) {
    ...
    private VideoTask toDomain(TaskEntity entity) {
        return new VideoTask(
                ...
                readJson(entity.getRequestJson(), VideoContracts.CreateVideoRequest.class),
                GenerationTaskStatus.valueOf(entity.getStatus()),
                entity.getProgress(),
                readNullableJson(entity.getResultJson(), VideoContracts.VideoResult.class),
                readNullableJson(entity.getErrorJson(), VideoContracts.VideoTaskError.class),
                entity.getCreatedAt(),
                entity.getUpdatedAt());
    }
    ...
    private String writeJson(Object value) {
        try {
            ...
            throw new IllegalStateException("Failed to serialize video task data", ex);
        }
    }
    ...
    private <T> T readJson(String json, Class<T> type) {
        try {
            ...
            throw new IllegalStateException("Failed to deserialize video task data", ex);
        }
    }
